...
class seminar
{
	...
	function __construct($seminar_id = null)
  {
		...
		if(!is_null($seminar_id))
		{
			...
			$sql->setDebug = true;
			//Stammdaten Seminar
			$querySeminar = 'SELECT seminar_start, seminar_ende, seminar_ort, seminar_typ, seminar_online
			...
			$querySemLok = 'SELECT clang, titel, untertitel, beschreibung, kosten, waehrung_id, zielgruppe
			FROM '.$REX['TABLE_PREFIX'].'skh3_seminare_lok
			WHERE seminar_id=' . $this->seminar_id . ';';
			...
			//ReferentInnen
			$querySemRefis = 'SELECT person_id FROM '.$REX['TABLE_PREFIX'].'skh3_refis WHERE seminar_id='.$this->seminar_id.';';
			...
			//Leitung
			$querySemLeitung = 'SELECT person_id FROM '.$REX['TABLE_PREFIX'].'skh3_leitung WHERE seminar_id='.$this->seminar_id.';';
			...
			//Verantwortung
			$querySemVerantwortung = 'SELECT person_id FROM '.$REX['TABLE_PREFIX'].'skh3_verantwortung WHERE seminar_id='.$this->seminar_id.';';
			...
			//Kooperationspartner
			$querySemPartner = 'SELECT partner_id FROM '.$REX['TABLE_PREFIX'].'skh3_koop WHERE seminar_id='.$this->seminar_id.';';
			...
			//Geldgeber
			$querySemGeldgeber = 'SELECT geldgeber_id FROM '.$REX['TABLE_PREFIX'].'skh3_foerdern WHERE seminar_id='.$this->seminar_id.';';
