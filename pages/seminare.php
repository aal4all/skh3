<?php
  ...
  { 
    ...
    { 
      ...
      echo('<label for="seminar_start">Beginn (jjjj-mm-tt):</label><input type="text" class="datepicker txt" name="seminar_start" id="seminar_start" value="' . $seminar->getSeminarStart() .'" /><br />') ;
