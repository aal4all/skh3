<?php
  ...
  */
  ...
  if ($func == '') {
    ...
    $query='SELECT '.$REX['TABLE_PREFIX'].'skh3_seminare.seminar_id, titel, seminar_start, seminar_ende, seminar_ort FROM '.$REX['TABLE_PREFIX'].'skh3_seminare INNER JOIN '.$REX['TABLE_PREFIX'].'skh3_seminare_lok ON '.$REX['TABLE_PREFIX'].'skh3_seminare.seminar_id = '.$REX['TABLE_PREFIX'].'skh3_seminare_lok.seminar_id WHERE '.$REX['TABLE_PREFIX'].'skh3_seminare_lok.clang='.$REX['CUR_CLANG'].' AND seminar_start < date(now()) '; 
        //echo $query;
